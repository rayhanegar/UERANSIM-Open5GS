...
CONFIG_SRC=${NF_CONFIG_SRC:-/etc/open5gs/custom/nrf.yaml}
CONFIG_DST=${NF_CONFIG_DST:-/etc/open5gs/nrf.yaml}
...
# If a custom configuration is mounted, copy it into place with proper ownership
