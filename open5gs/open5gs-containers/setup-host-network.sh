...
# Port forwarding for external gNB access (NGAP/N2 interface)
# Replace <YOUR_PUBLIC_IP> with your actual public/external IP
...
echo "4. Your gNB should connect to $PUBLIC_IP:38412 for N2 interface"
echo "5. Your gNB should connect to $PUBLIC_IP:2152 for N3 interface"
echo ""
